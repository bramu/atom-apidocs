...
Temporarily reserve a domain for your customer to prevent it from being purchased by someone else. Holds give your buyer time to complete their decision and payment.
...
Finalize the purchase of a held domain. This completes the transaction and initiates the domain transfer process.
...
| 3 | Hold Domain | Reserve a domain temporarily for your customer |
| 4 | Unhold Domain | Release the hold if the customer decides not to buy |
| 5 | Confirm Order | Complete the purchase |
